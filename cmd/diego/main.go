...
func main() {
	...
	preparedSchema := prepare(d, source)
	var generated bytes.Buffer
	if err := tmpl.Execute(&generated, preparedSchema); err != nil {
...
func prepare(d *diego.Schema, source string) *templateDiego {
	td := &templateDiego{
